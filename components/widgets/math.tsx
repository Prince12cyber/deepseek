...
const mathWidget: WidgetDefinition<{ expression: string }, MathWidgetState> = {
  kind: "math",
  version: "1.0.0",
    ...
    return (
      <div className="space-y-4">
        <div className="border rounded-lg p-4 bg-background">
          <h3 className="font-semibold mb-2">Math Widget</h3>
          <div className="mb-2">
          ...
          {graphData && (
            <div className="mt-4">
              ...
              {/* We would render a graph here using a charting library.
                  For now, we'll just show a placeholder. */}
              <div className="aspect-square border rounded bg-muted">
                <div className="flex h-full items-center justify-center text-sm text-muted-foreground">
                  Graph of y = {graphData.y[0]}x² + ... (placeholder)
                </div>
              </div>
            </div>
          )}
  ...
  actionHandlers: {
    ...
    solve: (_state, _setState) => {
      // Placeholder for future implementation
      // This could trigger a re-solve or other actions
    },
  },
};
